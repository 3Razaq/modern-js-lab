...
const userProfile = {
  [propertyName]: 'john_cena',
};
console.log(userProfile);
// ! Exercise 7: in exportingFile.js & importingFile.js
// ! Exercise 8:
...
sentence(); // Logs: The cat is orange.
sentence('dog', 'golden'); // Logs: The dog is golden.
// ! Exercise 9:
...
const pizza = 'tasty';
// Your code here:
let result = pizza === 'tasty' ? 'yum' : 'yuck';
console.log(result); // Logs: yum
// ! Exercise 10:
// ! 10.1: Set language
...
console.log(lang); // Logs: 'en' if localLangConfig is falsy, otherwise logs the value of localLangConfig
...
console.log(theme); // Logs: 'light' if savedUserTheme is falsy, otherwise logs the value of savedUserTheme
// ! Exercise 11:
...
// Your code here:
console.log(adventurer.cat?.age); // Logs: undefined, since adventurer.cat is undefined
